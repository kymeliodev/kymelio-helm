...
app.kubernetes.io/part-of: {{ include "questdb.name" . }}
{{- end }}
...
{{/*
Numeric value of the primary service port.
*/}}
{{- define "questdb.primaryPort" -}}
{{- index .Values.service.ports .Values.service.primaryPortName }}
{{- end }}
