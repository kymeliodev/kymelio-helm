...
Vault exposes telemetry at `/v1/sys/metrics?format=prometheus` on the API port
...
Vault terminates TLS in its listener. Provide the certificate and key through a
mounted Secret and reference them in the listener stanza of the server
configuration:
