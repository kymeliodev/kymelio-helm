...
TimescaleDB time series SQL database on PostgreSQL, deployed as a single primary
...
```sh
helm install my-timescaledb oci://ghcr.io/kymeliodev/kymelio-helm/timescaledb --version 0.1.0
```
...
```sh
helm upgrade my-timescaledb kymelio/timescaledb
```
...
| image.repository | string | `docker.io/timescale/timescaledb` | Container image repository |
...
| persistence.mountPath | string | `/var/lib/postgresql/data` | Data directory mount path |
| resources | object | requests and limits | Container resource requests and limits |
| podSecurityContext | object | runAsNonRoot 70 | Pod security context |
