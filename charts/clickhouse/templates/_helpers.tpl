...
app.kubernetes.io/part-of: {{ include "clickhouse.name" . }}
{{- end }}
...
{{/*
Resolve the user password. Reuse an existing value on upgrade so a
...
{{- else }}
{{- $existing := lookup "v1" "Secret" .Release.Namespace (include "clickhouse.fullname" .) }}
